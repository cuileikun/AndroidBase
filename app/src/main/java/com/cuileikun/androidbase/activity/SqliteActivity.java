...
import com.cuileikun.androidbase.db.MySQLiteOpenHelper;
...
public class SqliteActivity extends Activity {
    ...
    public void insert1(View view) {
        ...
        for (int i = 0; i < 50; i++) {
            database.execSQL(sql, new Object[] { "zhangsan" + i, 10 + i, "" + (5550 + i) });
        }
        // 释放资源
        database.close();
    ...
    public void delete1(View view) {
        ...
        database.execSQL(sql, new Object[] { 18 });
        // 释放资源
        database.close();
        Toast.makeText(this, "执行完毕", Toast.LENGTH_LONG).show();
    }
