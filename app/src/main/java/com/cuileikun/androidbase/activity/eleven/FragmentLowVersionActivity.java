...
import com.cuileikun.androidbase.fragment.Fragment4;

/**
 * Created by Admin on 2017/4/29.
 */

public class FragmentLowVersionActivity extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fragment_low_version);
        //[1]获取窗口的管理者
...
//            beginTransaction.replace(R.id.main_content, new Fragment4());
            beginTransaction.replace(android.R.id.content, new Fragment4());
        }
